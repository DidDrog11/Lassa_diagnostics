...
ui <- fluidPage(title = "Lassa fever diagnostics data extraction",
                fluidRow(
                  column(width = 12,
                         ...
                         helpText("If no animal species are included in the study then it is not relevant for further data extraction. Please ensure you press submit."),
                         conditionalPanel(condition = "input.Number_species >=1",
                                          ...
                                          conditionalPanel(condition = "input.Number_assay >= 1",
                                                           ...
                                                           conditionalPanel(condition = "input.Assay_type.includes('other')",
